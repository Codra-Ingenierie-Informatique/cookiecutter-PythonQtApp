...
"""
{{cookiecutter.project_slug}}.gui.mainwindow
"""
...
#  Local imports
from {{cookiecutter.project_slug}} import __version__, __author__
from {{cookiecutter.project_slug}}.config import APP_DESC, APP_NAME, DATAPATH, DEBUG, DEBUG_VAR_STR, Conf, _
...
from {{cookiecutter.project_slug}}.utils import qthelpers as qth


class MainWindow(QW.QMainWindow):
    """{{ cookiecutter.project_name }} main window"""

    MAX_RECENT_FILES = 10
    EXTENSION = "{{cookiecutter.file_extension}}"
    ...
    def __init__(self, fname=None):
        ...
        self.setWindowIcon(get_icon("{{cookiecutter.project_slug}}.svg"))
...
Thanks for your patience."""
    ...
    def create_menus(self):
        ...
        actions = self.central_widget.get_menu_actions()
        if "edit" in actions:
    ...
    def about(self):
        ...
        QW.QMessageBox.about(
            ...
            <p>{_('Software created by')} {__author__}
